...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            UiUtils.getContent().startActivity(new Intent(android.provider.Settings
                    .ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
            UiUtils.getContent().startActivity(new Intent(android.provider.Settings
                    .ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) UiUtils.getContent().getSystemService(Context
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) UiUtils.getContent()
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) UiUtils.getContent().getApplicationContext()
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) UiUtils.getContent()
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager tm = (TelephonyManager) UiUtils.getContent().getSystemService(Context
                .TELEPHONY_SERVICE);
